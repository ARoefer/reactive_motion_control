...
if(NOT "include;/usr/include/eigen3;/opt/ros/indigo/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'expressiongraph' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/adrian/bachelor_thesis/ws/install/${idir}'.  Ask the maintainer 'Erwin Aertbelien <erwin.aertbelien@kuleuven.be>' to fix it.")
    endif()
